...
class DnCNN(nn.Module):
    ...
    def __init__(self, nplanes_in, nplanes_out, features, kernel, depth, activation, residual, bn, lastact=None,
                 bn_momentum=0.10, padding=None):
        r"""
        :param nplanes_in: number of of input feature channels
        ...
        self.layers = make_net(nplanes_in, kernels, features, bns, acts, dilats=dilats, bn_momentum=bn_momentum,
                               padding=padding)
