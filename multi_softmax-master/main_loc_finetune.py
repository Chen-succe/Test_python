...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--train_list', default='data_txts/8g8/huokai_train_PIL_resize224.txt', type=str,help='dataset path')
    parser.add_argument('--train_add_list', default=['data_txts/8g8/Wtrain_PIL_resize224.txt'], type=list,help='add dataset path')
    ...
    parser.add_argument('--val_list', default='data_txts/8g8/huokai_test_PIL_resize224.txt', type=str,help='dataset path')
    parser.add_argument('--val_add_list', default=[],type=list, help='add dataset path')
    ...
    parser.add_argument('--freeze', action='store_true', help='finetune from checkpoint')
...
def main(args):
    ...
    if args.finetune:
        ...
        del checkpoint_model['head_loc_binary.weight']
        del checkpoint_model['head_loc_binary.bias']
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            args.clip_grad, args.clip_mode, ema, None, weight=args.mw, bi_class_weight=args.bi_class_weight,
            s=args.s, RDrop=args.RDrop)
...
if __name__ == '__main__':
    ...
    args.output_dir = f'run/{data[1]}_{data[2]}_{args.backbone_type}_LOC_Pretrain_MultiSoftmax'
    if not args.eval:
        args.output_dir += f'_HuokaiW_Dg_ClsW{args.bi_class_weight[0]}{args.bi_class_weight[1]}' \
                           f'_mw{args.mw}_bw{args.bw}_size{args.input_size}_epoch{args.epochs}'
        if args.resume:
        ...
        shutil.copy('./main_loc_finetune.py', args.output_dir + '/main_loc_finetune.py')
...
"""
python main_loc_finetune.py --gpus 3,4 --batch-size 512 --ema --finetune run/Jul_10_RepVGG_LOC_SplitINnoAttenAvg_MultiSoftmax_Huokai_Dg_ClsW91_mw1.0_bw1.0_lw1.0_size224_epoch100/epoch_70.pth  #--freeze
"""
