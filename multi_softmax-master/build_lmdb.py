...
def main(mode):
    proj_root = '/data/data1/haoyu.wang'
    lmdb_path = os.path.join(proj_root, 'huohua_test.lmdb')
    data_path = '/mnt/mfs2/ailun.li/data_txt/huokai/huokai_test.txt'
