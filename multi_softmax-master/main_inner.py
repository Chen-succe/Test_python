...
class FaceModel(torch.nn.Module):
    ...
    def __init__(self,num_classes,multi_head=False):
        ...
        #     torch.nn.Linear(1280, 512), # BMMD loss 计算1280太大
...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--train_list', default='data_txts/8g8/huokai_train_PIL_resize224_8g8.txt', type=str,help='dataset path')
    parser.add_argument('--train_add_list', default='data_txts/8g8/Wtrain_PIL_resize224.txt', type=str,help='dataset path')
    # ./huokai_train_PIL_resize224.txt
    parser.add_argument('--val_list', default='data_txts/8g8/huokai_test_PIL_resize224_8g8.txt', type=str,help='dataset path')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch==args.warmup_epochs+1:
            ...
            ema.ema.eval()
            args.consistency_loss_weight = 1.0
        ...
        if True:
            test_stats = evaluate_inner(data_loader_val, model, criterion, args.device, args.bi_class_weight,args.weight,args.consistency_loss_weight)
            if ema and epoch > args.warmup_epochs:
                logging.info('  ************ EMA ************  ')
                test_ema_stats = evaluate_inner(data_loader_val, ema.ema, criterion, args.device,args.bi_class_weight,args.weight,args.consistency_loss_weight)
...
if __name__ == '__main__':
    ...
    if not args.eval:
        args.output_dir += f'_Huokai_Dg_ClsW91_weight{args.weight}_MaxBatchMMD{args.consistency_loss_weight}_After1.0_margin{args.bmmd_margin}_size{args.input_size}'
        # args.output_dir += f'_Huokai_Dg_ClsW91_weight{args.weight}_CentesLoss{args.consistency_loss_weight}_size{args.input_size}'
        if args.resume:
        ...
        shutil.copy('./main_inner.py', args.output_dir + '/main_inner.py')
    ...
    main(args)
"""
python main_inner.py  --gpus 4,5 --multi_head --ema --batch-size 384 --consistency_loss_weight 0.0 --bmmd_margin 1.0
"""